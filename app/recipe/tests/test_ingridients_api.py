...
class PrivateIngredientsAPITests(TestCase):
    ...
    def test_retrieve_ingredients(self):
        '''test api to retrieve a list of ingredients'''
    ...
    def test_update_ingredient(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Salsinha')

        payload = {'name': 'Curcuma'}
    ...
    def test_delete_ingredient(self):
        ''' test update ingridient'''
        ingredient = Ingredient.objects.create(user=self.user, name='salada')
